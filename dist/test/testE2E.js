...
function run() {
    ...
    var only = lodash_1.find(modules, function (_) { return Boolean(_[1].only); });
    if (only) {
...
function runOne(exports, name) {
    var _this = this;
    utils_1.log('blue', 'Running test', name);
    ava_1.default(name, function (t) { return __awaiter(_this, void 0, void 0, function () {
        var e_1, _a, _b;
